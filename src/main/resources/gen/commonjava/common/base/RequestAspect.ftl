...
import ${packageName}.common.token.user.ActionEnum;
import ${packageName}.common.token.user.TokenVerify;
import ${packageName}.common.token.user.UserTokenHandler;
...
import static ${packageName}.common.token.user.UserTokenHandler.HEADER_NAME;
import static ${packageName}.common.token.user.UserTokenHandler.REQUEST_ATTRIBUTE_KEY;
...
public class RequestAspect {
    ...
    @Pointcut("execution(public java.util.Map ${packageName}.controller..*.*(..))")
